...
-- Volcando estructura de base de datos para asecreto
CREATE DATABASE IF NOT EXISTS `asecreto` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `asecreto`;

-- Volcando estructura para tabla asecreto.ams_banner
CREATE TABLE IF NOT EXISTS `ams_banner` (
...
-- Volcando datos para la tabla asecreto.ams_banner: ~0 rows (aproximadamente)
DELETE FROM `ams_banner`;
/*!40000 ALTER TABLE `ams_banner` DISABLE KEYS */;
/*!40000 ALTER TABLE `ams_banner` ENABLE KEYS */;

-- Volcando estructura para tabla asecreto.ams_bannerseccion
CREATE TABLE IF NOT EXISTS `ams_bannerseccion` (
...
-- Volcando datos para la tabla asecreto.ams_bannerseccion: ~0 rows (aproximadamente)
DELETE FROM `ams_bannerseccion`;
/*!40000 ALTER TABLE `ams_bannerseccion` DISABLE KEYS */;
/*!40000 ALTER TABLE `ams_bannerseccion` ENABLE KEYS */;

-- Volcando estructura para tabla asecreto.ams_categoria
CREATE TABLE IF NOT EXISTS `ams_categoria` (
...
-- Volcando datos para la tabla asecreto.ams_categoria: ~7 rows (aproximadamente)
DELETE FROM `ams_categoria`;
/*!40000 ALTER TABLE `ams_categoria` DISABLE KEYS */;
INSERT INTO `ams_categoria` (`CATEP_Codigo`, `CATEC_Nombre`, `CATEC_FechaRegistro`, `CATEC_FlagEstado`, `CATEC_NombreImagen`) VALUES
	...
	(6, 'REGALOS\r\n', NULL, '1', 'regalos.jpg\r\n'),
	(7, 'CUPONES\r\n', NULL, '1', 'cupones.jpg\r\n');
/*!40000 ALTER TABLE `ams_categoria` ENABLE KEYS */;

-- Volcando estructura para tabla asecreto.ams_empresa
CREATE TABLE IF NOT EXISTS `ams_empresa` (
...
-- Volcando datos para la tabla asecreto.ams_empresa: ~6 rows (aproximadamente)
DELETE FROM `ams_empresa`;
/*!40000 ALTER TABLE `ams_empresa` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `ams_empresa` ENABLE KEYS */;

-- Volcando estructura para tabla asecreto.ams_evento
CREATE TABLE IF NOT EXISTS `ams_evento` (
...
-- Volcando datos para la tabla asecreto.ams_evento: ~0 rows (aproximadamente)
DELETE FROM `ams_evento`;
/*!40000 ALTER TABLE `ams_evento` DISABLE KEYS */;
/*!40000 ALTER TABLE `ams_evento` ENABLE KEYS */;

-- Volcando estructura para tabla asecreto.ams_grupo
CREATE TABLE IF NOT EXISTS `ams_grupo` (
...
-- Volcando datos para la tabla asecreto.ams_grupo: ~8 rows (aproximadamente)
DELETE FROM `ams_grupo`;
/*!40000 ALTER TABLE `ams_grupo` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `ams_grupo` ENABLE KEYS */;

-- Volcando estructura para tabla asecreto.ams_logbanner
CREATE TABLE IF NOT EXISTS `ams_logbanner` (
...
-- Volcando datos para la tabla asecreto.ams_logbanner: ~0 rows (aproximadamente)
DELETE FROM `ams_logbanner`;
/*!40000 ALTER TABLE `ams_logbanner` DISABLE KEYS */;
/*!40000 ALTER TABLE `ams_logbanner` ENABLE KEYS */;

-- Volcando estructura para tabla asecreto.ams_producto
CREATE TABLE IF NOT EXISTS `ams_producto` (
  ...
  `PRODC_Descripcion` text DEFAULT NULL COMMENT 'Descripcion de un producto.',
  `PRODC_MensajePostal` text DEFAULT NULL COMMENT 'Mensaje Postal\n',
...
-- Volcando datos para la tabla asecreto.ams_producto: ~45 rows (aproximadamente)
DELETE FROM `ams_producto`;
/*!40000 ALTER TABLE `ams_producto` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `ams_producto` ENABLE KEYS */;

-- Volcando estructura para tabla asecreto.ams_punto
CREATE TABLE IF NOT EXISTS `ams_punto` (
...
-- Volcando datos para la tabla asecreto.ams_punto: ~0 rows (aproximadamente)
DELETE FROM `ams_punto`;
/*!40000 ALTER TABLE `ams_punto` DISABLE KEYS */;
/*!40000 ALTER TABLE `ams_punto` ENABLE KEYS */;

-- Volcando estructura para tabla asecreto.ams_tipodocumento
CREATE TABLE IF NOT EXISTS `ams_tipodocumento` (
...
-- Volcando datos para la tabla asecreto.ams_tipodocumento: ~2 rows (aproximadamente)
DELETE FROM `ams_tipodocumento`;
/*!40000 ALTER TABLE `ams_tipodocumento` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `ams_tipodocumento` ENABLE KEYS */;

-- Volcando estructura para tabla asecreto.ams_ubigeo
CREATE TABLE IF NOT EXISTS `ams_ubigeo` (
...
-- Volcando datos para la tabla asecreto.ams_ubigeo: ~0 rows (aproximadamente)
DELETE FROM `ams_ubigeo`;
/*!40000 ALTER TABLE `ams_ubigeo` DISABLE KEYS */;
INSERT INTO `ams_ubigeo` (`UBIGP_Codigo`, `UBIGC_CodDpto`, `UBIGC_CodProv`, `UBIGC_CodDist`, `UBIGC_Descripcion`, `UBIGC_FlagEstado`) VALUES
	('000000', '00', '00', '00', '', '1');
/*!40000 ALTER TABLE `ams_ubigeo` ENABLE KEYS */;

-- Volcando estructura para tabla asecreto.ams_usuario
CREATE TABLE IF NOT EXISTS `ams_usuario` (
...
-- Volcando datos para la tabla asecreto.ams_usuario: ~0 rows (aproximadamente)
DELETE FROM `ams_usuario`;
/*!40000 ALTER TABLE `ams_usuario` DISABLE KEYS */;
INSERT INTO `ams_usuario` (`USUAP_Codigo`, `TIPOP_Codigo`, `UBIGP_Codigo`, `USUAC_Correo`, `USUAC_Password`, `USUAC_Apellidos`, `USUAC_Nombres`, `USUAC_Foto`, `USUAC_FechaNacimiento`, `USUAC_FechaRegistro`, `USUAC_FechaModificacion`, `USUAC_NumeroDocumento`, `USUAC_Telefono`, `USUAC_Sexo`, `USUAC_Ciudad`, `USUAC_FlagEnviado`, `USUAC_FlagConfirmado`, `USUAC_FlagPromociones`, `USUAC_FlagNotificaciones`, `USUAC_FlagEstado`, `USUAC_FlagAdministrador`, `USUAC_FlagBienvenida`) VALUES
	(2, 1, '000000', 'demo@correo.com', '123456', 'Vila', 'Ricardo', '', '1963-05-05 00:00:00', '2010-11-18 18:56:08', NULL, '10101010', '4569874', b'1', 'JUNIN', '1', '1', '1', '1', '1', '1', '1');
/*!40000 ALTER TABLE `ams_usuario` ENABLE KEYS */;

-- Volcando estructura para tabla asecreto.ams_usuariogrupo
CREATE TABLE IF NOT EXISTS `ams_usuariogrupo` (
...
-- Volcando datos para la tabla asecreto.ams_usuariogrupo: ~0 rows (aproximadamente)
DELETE FROM `ams_usuariogrupo`;
/*!40000 ALTER TABLE `ams_usuariogrupo` DISABLE KEYS */;
/*!40000 ALTER TABLE `ams_usuariogrupo` ENABLE KEYS */;

-- Volcando estructura para tabla asecreto.ams_usuariogrupoevento
CREATE TABLE IF NOT EXISTS `ams_usuariogrupoevento` (
...
-- Volcando datos para la tabla asecreto.ams_usuariogrupoevento: ~0 rows (aproximadamente)
DELETE FROM `ams_usuariogrupoevento`;
/*!40000 ALTER TABLE `ams_usuariogrupoevento` DISABLE KEYS */;
/*!40000 ALTER TABLE `ams_usuariogrupoevento` ENABLE KEYS */;

-- Volcando estructura para tabla asecreto.ams_usuariogrupopunto
CREATE TABLE IF NOT EXISTS `ams_usuariogrupopunto` (
...
-- Volcando datos para la tabla asecreto.ams_usuariogrupopunto: ~0 rows (aproximadamente)
DELETE FROM `ams_usuariogrupopunto`;
/*!40000 ALTER TABLE `ams_usuariogrupopunto` DISABLE KEYS */;
/*!40000 ALTER TABLE `ams_usuariogrupopunto` ENABLE KEYS */;
