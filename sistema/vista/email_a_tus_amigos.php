...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Juega al amigo secreto con Paginas Amarillas</title>
  ...
  <body>
          ...
          <div class="item002">
	        ...
	        <div class="case_invi">
				...
				<table width="540" border="0" cellspacing="0" cellpadding="0" class="nobor">
				  ...
				  <tr>
                                    <td id="basic-modal3">
                                        <input type="hidden" id="txtCantidad" name="txtCantidad" value="<?php echo $cantidad-1;?>"/>
                                        <a href="#" class="enviar basic"></a>
                                    </td>
				  </tr>
				</table>
			  </div>
    ...
    <div id="basic-modal-content">
        <div style="padding:35px 12px 0 12px; text-align:center; font-size:12px; color:#666" >
            <img src="images/tit-invitaciones-enviadas.gif"/><br />
                Las invitaciones han sido enviadas a tus amigos satisfactoriamente.<br />
                Una vez que hayan confirmado 5 personas como mínimo, será posible realizar el sorteo y agendar
                la fecha de la entrega de regalos.
                <br /><br />
           	Igresa a la página de tu grupo
                <br /><br />
            <div class="case_btn" id="btn_verpag"><a href="#" class="btn_verpag basic"></a></div>
        </div>
    </div>
  </body>
</html>