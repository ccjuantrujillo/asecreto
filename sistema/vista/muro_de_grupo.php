        ...
        <div class="stream">
          ...
          <div class="item002">
          	<div id="box_user">
                ...
                <div class="btn_escribele_jg"><a href="#"></a></div>
            </div>
				...
				?>
					<li class="item_box">
						...
						foreach($lista_comentario as $fila2=>$arrayComentario){
							...
							$datos_usuario  = $oAdmin2->datos_usuario($usuario);
						...
						<a href="#" class="imgb"><img src="<?php echo $foto_usuario;?>" width="49" height="49" alt="user" /></a>
						<div class="msm sub_msm">
								<strong><?php echo $nombre_usuario;?>:</strong><br />
								<span><?php echo $comentario;?></span>
								<div align="right">
								| <a href="#" onclick="eliminar_comentario(<?php echo $idcomentario;?>);">Eliminar</a> |
								</div>
						  </div>
						</div>	
						<?php
